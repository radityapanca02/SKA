            ...
            <div class="bg-white p-4 md:p-5 rounded-xl shadow-sm">
                ...
                <div id="x-sidenews" class="space-y-4" data-news-container>
                    ...
                    <div class="sidenews-item cursor-pointer transition-colors duration-200 hover:bg-gray-50 p-2 rounded-lg"
                        ...
                        data-news-desc="{{ $berita->deskripsi }}" data-news-image="{{ !is_null($berita->gambar) ? $assetBase . '/storage/' . $berita->gambar : 'https://placehold.co/600x400' }}">
                        <x-sidenews :title="$berita->title" :image="!is_null($berita->gambar) ? $assetBase . '/storage/' . $berita->gambar : 'https://placehold.co/600x400'" loading="lazy" />
                    </div>
                    @endforeach
