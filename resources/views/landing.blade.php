                            ...
                            <div class="card absolute inset-0 bg-white rounded-2xl shadow-lg overflow-hidden h-80 transition-all duration-700"
                                ...
                                <div class="flex flex-col h-full">
                                    ...
                                    <div class="w-full p-4 flex flex-col justify-between">
                                        ...
                                        <a href="/jurusan"
                                            class="redirect-btn redirect-department relative z-[999] bg-customOrange text-white px-4 py-2 rounded-lg text-xs font-semibold hover:bg-customBlue transition w-full text-center z-50 pointer-events-auto">Selengkapnya
                                            →</a>
                                    </div>
                                </div>
                            </div>
