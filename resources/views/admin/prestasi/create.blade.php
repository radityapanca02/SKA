<x-admin-layout>
    <h1 class="text-xl sm:text-2xl font-bold mb-4">Tambah Prestasi</h1>
    ...
    <form action="{{ route('admin.prestasi.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div>
            ...
            <input type="text" name="subjudul" value="{{ old('subjudul') }}" class="w-full border rounded p-2 text-sm" required
                maxlength="100">
        </div>
